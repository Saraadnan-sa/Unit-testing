...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
    	...
    	// If the code was written by the student
        if (writtenByYourself) {
            // They can use it unless it's available to others
            return !availableToOthers;
        }

        // If the code wasn't written by the student, check the conditions
        if (!writtenByYourself) {
            // The code can be used only if citing the source and implementation is not required
            return citingYourSource && !implementationRequired;
        }

        // Default case (this shouldn't be reached given the above logic)
//        return false;
